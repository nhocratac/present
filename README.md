...
| Slide | Minh hoạ |
|---|---|
| 04 — Hai liveness channel | heartbeat thread vs main thread chạy thật; giả lập *xử lý treo* và *kill -9* để thấy channel nào kêu |
...
| 09 — Static membership | rolling deploy 20 pod: 40 rebalance vs 0 |
| 11 — pause() / resume() | worker chạy 4 phút, poll loop vẫn giữ đúng lời hứa với channel 2 |
...
js/anim-static.js       slide 9
js/anim-pause.js        slide 11
```
